...
import { Search, Car, MapPin, Filter, X, Users } from 'lucide-react';
...
export const PassengerPage = () => {
  ...
  const fetchVehicles = async (searchFilters = {}) => {
    ...
    try {
      ...
      params.append('vehicle_type', 'passenger');
  ...
  const hasActiveFilters = filters.city || filters.maxPrice;

  return (
    <div className="min-h-screen pt-20 pb-12" data-testid="passenger-page">
      {/* Hero */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-zinc-500">Знайдіть автомобіль з водієм для поїздки</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 mb-8">
        <div className="max-w-7xl mx-auto">
          <form onSubmit={handleSearch} className="card-glass p-6">
            ...
            {/* Extended Filters */}
            {showFilters && (
              <div className="mt-4 pt-4 border-t border-zinc-800 grid sm:grid-cols-2 gap-4">
                <div>
