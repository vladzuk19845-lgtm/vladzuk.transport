...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 pt-20" data-testid="login-page">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500">Увійдіть до свого кабінету</p>
        </div>
        ...
        <div className="card-glass p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-zinc-500">
              ...
              <Link to="/register" className="text-[#00ff94] hover:underline" data-testid="login-register-link">
